...
- Live nearby aircraft within a 20-mile look-out radius from Airplanes.live
...
The board keeps its live positions free and fast through Airplanes.live. Every 12 hours, a GitHub Action can enrich up to eight nearby non-Auburn callsigns within the 20-mile lookout with FlightAware AeroAPI flight details and saves only that small public cache in `flightaware-enrichment.json`. Auburn `AUB` flights always retain the Auburn logo and supplied Skyhawk image.
